...
import com.ok.londonloot.navigation.utilz.LabelView
...
fun SignUpButton(navController: NavController?){
    Button(modifier = Modifier
        ...
        .padding(16.dp, 0.dp, 16.dp, 0.dp),
        onClick = {
            navController?.navigate(route = LondonLootOnBoardingScreens.OtpVerificationScreen.name)
        },
...
@Composable
fun LondonLootSignUpScreenPreview() {
    LondonLootTheme {
