...
package com.ok.londonloot.onboarding
...
import com.ok.londonloot.mainActivities.HomeMainActivity
import com.ok.londonloot.mainActivities.OnBoardingMainActivity
import com.ok.londonloot.navigation.onBoardingNavigation.LondonLootOnBoardingScreens
import com.ok.londonloot.onboarding.model.Country
...
fun LoginMainScreen(navController: NavController?) {
    ...
    Box(
        modifier = Modifier
            ...
            .fillMaxSize()
            .paint(
                painterResource(id = R.drawable.londonbuss),
        ...
        Row(modifier = Modifier
            ...
            Surface(modifier = Modifier
                ...
                onClick = {
                    ...
                    navController?.navigate(route = LondonLootOnBoardingScreens.CountryCodeSelectionScreen.name)
...
fun TopHeading(navController: NavController?){
    Column(modifier = Modifier
        ...
        Row(modifier = Modifier
            ...
            .clickable {
                navController?.navigate(route = LondonLootOnBoardingScreens.SignUpScreen.name)
            },
            horizontalArrangement = Arrangement.Center
        ) {
            Divider(
